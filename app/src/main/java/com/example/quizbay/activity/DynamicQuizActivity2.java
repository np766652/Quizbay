...
public class DynamicQuizActivity2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (!hashmapstring.equals("empty"))
        {
            ...
            quizId = getKey(quizContextMapping.getQuizContext(),"DynamicQuizActivity2.class");
    ...
    {
        SharedPreferences sharedPreferences = getSharedPreferences(getPackageName(),Context.MODE_PRIVATE);
        Log.d("abc", "setView: "+quizId);
        questionString = sharedPreferences.getString(quizId,"0");
        Log.d("QuizIdString", "setView: "+questionString);
